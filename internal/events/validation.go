...
var payloadTypes = map[EventType]reflect.Type{
	...
	AnalysisSkipped:            reflect.TypeOf(&IngestDecisionEvent{}),
	AnalysisSemanticComplete:   reflect.TypeOf(&AnalysisEvent{}),
	AnalysisEmbeddingsComplete: reflect.TypeOf(&AnalysisEvent{}),
	GraphPersistenceFailed:     reflect.TypeOf(&GraphEvent{}),
	GraphFatal:                 reflect.TypeOf(&GraphFatalEvent{}),
	GraphConnected:             reflect.TypeOf(&GraphConnectionEvent{}),
	GraphDisconnected:          reflect.TypeOf(&GraphConnectionEvent{}),
	GraphWriteQueueFull:        reflect.TypeOf(&GraphBackpressureEvent{}),
	QueueDegradationChanged:    reflect.TypeOf(&QueueDegradationEvent{}),
	WatcherDegraded:            reflect.TypeOf(&WatcherDegradedEvent{}),
	WatcherRecovered:           reflect.TypeOf(&WatcherDegradedEvent{}),
	...
	RebuildStarted:             reflect.TypeOf(&RebuildStartedEvent{}),
